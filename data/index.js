...
var capacity = new attribute_set_1.default("Capacity").addItemList([new attribute_1.default("512G"), new attribute_1.default("1T")]);
var products = [
    ...
    new product_1.default("iMac 2021")
        ...
        .addAttributeSet(new attribute_set_1.default("Capacity").addItem(new attribute_1.default("256GB")).addItem(new attribute_1.default("512GB")))
