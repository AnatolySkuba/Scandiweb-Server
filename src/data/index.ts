...
const capacity = new AttributeSet("Capacity").addItemList([new Attribute("512G"), new Attribute("1T")]);
...
const products: Product[] = [
	...
	new Product("iMac 2021")
		...
		.addAttributeSet(new AttributeSet("Capacity").addItem(new Attribute("256GB")).addItem(new Attribute("512GB")))
